...
{
    static int xs, ys, xe, ye; // coordinates of the line to be clipped
    static int xleft, ytop, xright, ybottom; // clipping rectangle
    HDC hdc;
    PAINTSTRUCT ps;
    HPEN hPen ;
    switch (message)
    ...
    case WM_PAINT:
    {
        ...
        xs = 50, ys = 50, xe = 200, ye = 200;

        // Define the clipping rectangle
        xleft = 100, ytop = 100, xright = 300, ybottom = 300;
